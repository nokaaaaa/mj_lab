// Ported from deploy/robots/g1_23dof. The only robot-specific part is how the
// torso (anchor body) orientation is composed from the waist joints; see the
// comments at each site below.
